...
public class News implements Parcelable, Cloneable{
    ...
    public boolean equals(Object o) {
        ...
        return id == news.id &&
                avaURL == news.avaURL &&
                contentImgURL == news.contentImgURL &&
                liked == news.liked &&
                likesNo == news.likesNo &&
                commentsNo == news.commentsNo &&
                viewsNo == news.viewsNo &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, avaURL, contentImgURL, author, date, text, liked, likesNo, commentsNo, viewsNo);
    }
